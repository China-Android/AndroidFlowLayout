...
public class FlowLayout extends ViewGroup {
    ...
    public static final int DEFAULT_HORIZONTAL_MARGIN = dptopx.dip2px(5f);//元素之间的水平间距
    public static final int DEFAULT_VERTICAL_MARGIN = dptopx.dip2px(5f);//元素之间的竖直间距
    public static final int DEFAULT_TEXT_MAX_LENGTH = -1;//元素里面的字体长度限制
    public static final int DEFAULT_BORDER_RADIUS =dptopx.dip2px(5f);//元素外面的边框弧度
